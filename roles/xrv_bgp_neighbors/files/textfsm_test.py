...
if __name__ == '__main__':
  ...
  def main():
    ...
    textfsm_path = os.path.join(app_dir, 'cisco_xrv_show_bgp_neighbors_neighbor.textfsm')
    try:
    ...
    textfsm_path = os.path.join(app_dir, 'cisco_xrv_show_bgp_neighbors_afi.textfsm')
    try:
      with open(textfsm_path) as f:
        table = textfsm.TextFSM(f)
        header = table.header
